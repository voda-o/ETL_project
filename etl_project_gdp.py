...
def extract(url, table_attrs):
    ...
    from the website and saves it to a dataframe.'''
...
def transform(df):
    ''' Converts the GDP information from Currency format to float value.
    transforms the information of GDP from USD (Millions) to USD (Billions) 
...
''' Define the required entities and call the relevant 
